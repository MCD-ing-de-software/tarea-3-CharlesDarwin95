...
class TestStatisticsUtils(unittest.TestCase):
    ...
    def test_moving_average_basic_case(self):
        ...
        """
        # Arrange: Preparación de la clase y los datos
        utils = StatisticsUtils()
    ...
    def test_moving_average_only_accepts_1d_sequences(self):
        ...
        with self.assertRaises(ValueError):
            utils.moving_average(arr_2d, window)
    ...
    def test_zscore_has_mean_zero_and_unit_std(self):
        ...
        self.assertAlmostEqual(result.mean(), expected_mean, delta=1e-10)
        self.assertAlmostEqual(result.std(), expected_std, delta=1e-10)
    ...
    def test_min_max_scale_maps_to_zero_one_range(self):
        ...
        npt.assert_allclose(result, expected_scaled, atol=1e-10)

        self.assertAlmostEqual(result.min(), 0.0, delta=1e-10)
        self.assertAlmostEqual(result.max(), 1.0, delta=1e-10)
